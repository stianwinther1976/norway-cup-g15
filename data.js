...
const DATA = (function(){
  ...
  const groups = [
    G(1, [["Stryn T&IL",3,0,0,16,2],["Utleira IL",2,0,1,7,2],["Oppsal IF Fotball 1",0,1,2,2,11],["Os TF 2",0,1,2,2,12]]),
    G(2, [["Trond, IL",3,0,0,10,0],["Randesund IL 2",1,1,1,4,3],["Elverum Fotball Hvit",1,0,2,3,9],["Tertnes Fotball Herrer",0,1,2,2,7]]),
    G(3, [["Måløy FK",3,0,0,9,2],["Sykkylven IL",2,0,1,6,2],["Astor Fotballklubb 2",1,0,2,7,4],["Haslum IL Hvit",0,0,3,0,14]]),
    G(4, [["KFUM-Kam. Oslo 1",3,0,0,27,1],["Strømsgodset IF",2,0,1,11,3],["Øygarden IL",1,0,2,2,15],["Nessegutten/Sverre",0,0,3,0,21]]),
    G(5, [["Manglerud Star Fotball 1",3,0,0,9,2],["Bergen Nord Fotball",2,0,1,14,3],["Otta IL",1,0,2,3,6],["Giv Akt, IL",0,0,3,2,17]]),
    G(6, [["Åsane Fotball",2,1,0,9,3],["BVH-G15-Lag1 (Bærums Verk)",2,1,0,7,4],["Kolnes IL",1,0,2,6,6],["Rival, SK",0,0,3,2,11]]),
    G(7, [["Askøy FK",3,0,0,7,1],["Colégio Arbos",1,1,1,2,2],["Etne IL 2",1,1,1,2,3],["HSV Fotball 1",0,0,3,1,6]]),
    G(8, [["KFUM-Kam. Oslo 2",2,1,0,16,2],["Baune, SK",2,0,1,7,9],["Frøya IL Born 2011",1,1,1,6,9],["Tune IL",0,0,3,2,11]]),
    G(9, [["Klemetsrud IL 2",2,1,0,8,1],["Torridal IL",2,1,0,7,0],["HIF/Stein",1,0,2,2,5],["Folldal IF",0,0,3,0,11]]),
    G(10, [["Os TF 1",3,0,0,20,3],["IL ROS",1,1,1,8,5],["V. Sverresborg/Vestbyen",1,1,1,8,9],["Hasle-Løren IL 2",0,0,3,1,20]]),
    G(11, [["Jevnaker IF",3,0,0,14,1],["Manglerud Star Fotball 2",1,1,1,8,3],["Florø SK",1,1,1,7,7],["Nessegutten/Sverre 2",0,0,3,0,18]]),
    G(12, [["Follo FK",3,0,0,21,0],["Elverum Fotball Sort",1,1,1,6,6],["Oppsal IF Fotball 2",1,0,2,3,16],["Askvoll IL",0,1,2,1,9]]),
    G(13, [["Bærum SK A",3,0,0,14,0],["Flekkerøy",2,0,1,3,2],["Etne IL 1",1,0,2,3,9],["Nordre Land IL/Torpa",0,0,3,1,10]]),
    G(14, [["Gjøa Youth (Brooklyn)",3,0,0,17,0],["Bremnes IL",2,0,1,7,1],["Verdal IL",1,0,2,7,7],["Klemetsrud IL 1",0,0,3,0,23]]),
    G(15, [["Kolbotn IL 1",3,0,0,15,1],["Oppdal IL G15",2,0,1,4,7],["Storm BK 1",1,0,2,3,4],["Ringebu-Fåvang FK",0,0,3,1,11]]),
    ...
    G(25, [["Tallinna JK Augur",2,1,0,12,3],["Vålerenga Fotball 1",2,1,0,12,3],["SK Vard Haugesund 2",1,0,2,9,5],["Vinne IL",0,0,3,0,22]]),
    G(26, [["Melhus IL",3,0,0,9,2],["Sædalen Idrettslag",2,0,1,12,3],["Surnadal IL",1,0,2,5,8],["KFUM-Kam. Oslo 3",0,0,3,3,16]]),
    G(27, [["SK Vard Haugesund 1",3,0,0,13,0],["Osterøy IL",2,0,1,3,2],["HSV Fotball 2",1,0,2,8,6],["Vålerenga Fotball 2",0,0,3,0,16]]),
    G(28, [["Finnøy IL",1,2,0,5,3],["Ørsta IL",1,2,0,6,5],["Varegg/Sandviken 2",1,1,1,4,4],["Snarøya SK",0,1,2,3,6]]),
    G(29, [["Nord, SK",3,0,0,9,2],["Gossen IL Gekko",2,0,1,16,4],["Odda FK",1,0,2,12,3],["Bærums Verk Hauger 3/4",0,0,3,1,29]]),
    G(30, [["Sogndal IL",3,0,0,12,0],["Ranheim IL 2",1,0,2,5,8],["Vågå/Lom",1,0,2,5,8],["Skeid",1,0,2,7,13]]),
    G(31, [["Gui Sportsklubb",2,1,0,8,1],["Krokelvdalen Idrettslag",1,1,1,4,6],["Nationalkameratene",0,2,1,4,6],["Eidsvåg IL",0,2,1,1,4]]),
    G(32, [["Åndalsnes",3,0,0,11,8],["Orkanger IF",2,0,1,14,6],["Grüner Fotball",1,0,2,10,11],["Vestsiden-Askøy IL",0,0,3,2,12]]),
    G(33, [["Kjelsås IL 1",3,0,0,8,1],["Eid IL",1,0,2,5,6],["Freidig, SPK",1,0,2,4,5],["Træff",1,0,2,1,6]]),
    G(34, [["Bauleni United (BUSA)",3,0,0,10,3],["Greåker IF",1,1,1,2,4],["Frigg Oslo FK",0,2,1,5,8],["Guard/Rollon",0,1,2,3,5]]),
    G(35, [["Grorud IL",2,0,1,11,4],["Emblem IL",1,2,0,4,1],["Kopervik IL G15",0,2,1,0,2],["Stjørdals-Blink",0,2,1,0,8]])
  ];
