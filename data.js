...
const DATA = (function(){
  ...
  const meta = {
    ...
    updated: "28.07.2026 kl. 19:05",
    sourceUrl: "https://norwaycup.cupmanager.net/2026,nb/result/division/80269931",
    favorite: "Gui Sportsklubb",
    note: "De fleste gruppene er nå ferdigspilte. Lagene er plassert i treet slik gruppene ligger an nå – alt gult/stiplet er foreløpig til gruppene er ferdigspilt."
  };
  ...
  const groups = [
    ...
    G(2, [["Trond, IL",2,0,0,5,0],["Randesund IL 2",1,1,1,4,3],["Elverum Fotball Hvit",1,0,1,3,4],["Tertnes Fotball Herrer",0,1,2,2,7]]),
    G(3, [["Måløy FK",2,0,0,6,0],["Sykkylven IL",2,0,1,6,2],["Astor Fotballklubb 2",1,0,1,5,1],["Haslum IL Hvit",0,0,3,0,14]]),
    ...
    G(8, [["Baune, SK",2,0,1,7,9],["KFUM-Kam. Oslo 2",1,1,0,10,2],["Frøya IL Born 2011",1,1,1,6,9],["Tune IL",0,0,2,2,5]]),
    G(9, [["Klemetsrud IL 2",2,0,0,8,1],["Torridal IL",2,0,0,7,0],["HIF/Stein",1,0,2,2,5],["Folldal IF",0,0,3,0,11]]),
    G(10, [["Os TF 1",2,0,0,9,3],["IL ROS",1,1,1,8,5],["V. Sverresborg/Vestbyen",1,1,1,8,9],["Hasle-Løren IL 2",0,0,2,1,9]]),
    G(11, [["Jevnaker IF",3,0,0,14,1],["Manglerud Star Fotball 2",1,1,1,8,3],["Florø SK",1,1,1,7,7],["Nessegutten/Sverre 2",0,0,3,0,18]]),
    G(12, [["Follo FK",3,0,0,21,0],["Elverum Fotball Sort",1,0,1,5,5],["Oppsal IF Fotball 2",1,0,2,3,16],["Askvoll IL",0,0,2,0,8]]),
    G(13, [["Bærum SK A",3,0,0,14,0],["Flekkerøy",2,0,1,3,2],["Etne IL 1",1,0,2,3,9],["Nordre Land IL/Torpa",0,0,3,1,10]]),
    G(14, [["Gjøa Youth (Brooklyn)",2,0,0,14,0],["Bremnes IL",2,0,1,7,1],["Verdal IL",1,0,1,7,4],["Klemetsrud IL 1",0,0,3,0,23]]),
    ...
    G(18, [["Langfjorden FK/Skåla",1,2,0,6,4],["Sportsklubben Karmøy",1,1,0,3,1],["Grei, SF",1,1,1,2,3],["Rosendal TL",0,0,2,2,5]]),
    ...
    G(26, [["Melhus IL",3,0,0,9,2],["Sædalen Idrettslag",2,0,1,12,3],["Surnadal IL",0,0,2,1,6],["KFUM-Kam. Oslo 3",0,0,2,1,12]]),
